...
func (uq *UserQuery) QueryMenus() *MenuQuery {
	query := &MenuQuery{config: uq.config}
...
func (uq *UserQuery) WithMenus(opts ...func(*MenuQuery)) *UserQuery {
	query := &MenuQuery{config: uq.config}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withMenus; query != nil {
		...
		query.Where(predicate.Menu(func(s *sql.Selector) {
			s.Where(sql.InValues(user.MenusColumn, fks...))
		}))
