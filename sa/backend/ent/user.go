...
func (e UserEdges) MenusOrErr() ([]*Menu, error) {
	if e.loadedTypes[0] {
		return e.Menus, nil
	}
...
// QueryMenus queries the menus edge of the User.
func (u *User) QueryMenus() *MenuQuery {
	return (&UserClient{config: u.config}).QueryMenus(u)
}
